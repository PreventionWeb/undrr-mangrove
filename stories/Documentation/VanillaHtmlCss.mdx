...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/mangrove/2.0.0-alpha.4/css/style-mcr.css"
/>
```
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/mangrove/2.0.0-alpha.4/css/style-irp.css"
/>
```
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/mangrove/2.0.0-alpha.4/css/style-delta.css"
/>
```
...
<script type="module">
  ...
  import ShareButtons, {
    fromElement,
  } from 'https://assets.undrr.org/mangrove/2.0.0-alpha.4/components/ShareButtons.js';
...
<script type="module">
  ...
  const MegaMenuModule =
    await import('https://assets.undrr.org/mangrove/2.0.0-alpha.4/components/MegaMenu.js');
  let MegaMenu = MegaMenuModule?.default ?? MegaMenuModule;
  if (typeof MegaMenu !== 'function' && MegaMenu?.default) {
    MegaMenu = MegaMenu.default;
  }
