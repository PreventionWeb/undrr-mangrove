...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/css/style-preventionweb.css"
/>
```
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/css/style-mcr.css"
/>
```
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/css/style-irp.css"
/>
```
...
<link
  rel="stylesheet"
  href="https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/css/style-delta.css"
/>
```
...
<script type="module">
  ...
  import ShareButtons, {
    fromElement,
  } from 'https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/components/ShareButtons.js';
...
<script type="module">
  ...
  const MegaMenuModule =
    await import('https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/components/MegaMenu.js');
  let MegaMenu = MegaMenuModule?.default ?? MegaMenuModule;
  if (typeof MegaMenu !== 'function' && MegaMenu?.default) {
    MegaMenu = MegaMenu.default;
  }
