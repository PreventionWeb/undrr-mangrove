...
>
  ...
  <HighlightBox variant="primary">
    ...
    <br />
    We need to work with all the different stakeholders to complete our mission.
  </HighlightBox>
  <HighlightBox variant="primary">
...
See: <LinkTo kind="components-pageheader" story="docs">Page header component</LinkTo>, <LinkTo kind="components-navigation-megamenu" story="docs">Mega menu component</LinkTo>
...
External-facing print/web uses **Roboto** (UN official typeface) for body text
and headings, with **Roboto Condensed** for the hero title and for interface
chrome such as card titles, tabs and tags. Internal/email communication may use
Arial. In CSS, name a font role — `var(--mg-font-family-text)`, `-heading`,
`-display`, `-ui` or `-code` — and never a typeface.
