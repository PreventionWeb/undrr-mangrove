...
- <LinkTo kind="getting-started-about-mangrove" story="docs">
    About Mangrove
  </LinkTo>
  -- what's shared across UNDRR properties
- <LinkTo kind="getting-started-accessibility" story="docs">
    Accessibility
  </LinkTo>
  -- WCAG requirements and patterns
