...
<script
  type="module"
  src="https://assets.undrr.org/static/mangrove/2.0.0-alpha.4/js/table-of-contents.js"
></script>
```
...
```js
import { mgTableOfContents } from 'https://assets.undrr.org/static/mangrove/2.0.0-alpha.4/js/table-of-contents.js';
...
- **1.8** — 2026-09-09 ([#1105](https://github.com/unisdr/undrr-mangrove/issues/1105)): Added a restrained inline divider, consistent list rhythm and explicit link focus. Indentation follows writing direction; React anchor scrolling now honours reduced motion, matching the vanilla implementation.
