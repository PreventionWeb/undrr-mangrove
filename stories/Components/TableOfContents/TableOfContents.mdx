...
<script
  type="module"
  src="https://assets.undrr.org/mangrove/2.0.0-alpha.4/js/table-of-contents.js"
></script>
```
...
```js
import { mgTableOfContents } from 'https://assets.undrr.org/mangrove/2.0.0-alpha.4/js/table-of-contents.js';
