...
<script
  type="module"
  src="https://assets.undrr.org/static/mangrove/1.8.1/js/table-of-contents.js"
></script>
```
...
```js
import { mgTableOfContents } from 'https://assets.undrr.org/static/mangrove/1.8.1/js/table-of-contents.js';
