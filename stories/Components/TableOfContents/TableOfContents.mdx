...
<script
  type="module"
  src="https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/js/table-of-contents.js"
></script>
```
...
```js
import { mgTableOfContents } from 'https://assets.undrr.org/static/mangrove/2.0.0-alpha.3/js/table-of-contents.js';
