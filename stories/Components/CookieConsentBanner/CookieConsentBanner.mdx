...
- **1.3** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Aligned consent-action typography with the shared button foundation by using regular Roboto and the Arabic body family.
- **1.2** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Added an imported Mangrove theme bridge for the CDN consent interface. Banner surfaces, text, links, buttons, toggles, separators, focus, motion, and RTL fonts now follow semantic Mangrove tokens while consent actions retain a clear filled-button hierarchy.
