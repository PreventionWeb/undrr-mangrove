...
- **1.6.4** — 2026-09-10 ([undrr/web-backlog#3060](https://gitlab.com/undrr/web-backlog/-/work_items/3060)):
  - Removed restrictive title width caps and cleaned up split-layout spacing/alignment so text aligns with shared container rhythm.
  - Simplified title markup/styles by removing dead classes/wrappers and applying `mg-hero__title` directly to the heading.
...
- **1.6** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)):
  - Introduced a directional gradient refresh for better contrast and theme control in LTR/RTL.
  - Improved CTA spacing/responsiveness and preserved CTA variant behavior across hero variants.
