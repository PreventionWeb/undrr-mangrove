...
- **1.6** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)):
  ...
  - Preserved the compact transparent CTA treatment across every colour variant by preventing conventional primary and secondary button overrides from leaking into `.mg-button-cta`.
