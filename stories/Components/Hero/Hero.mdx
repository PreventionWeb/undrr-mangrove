...
- **1.7** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Hero CTA groups now switch from an inline row to an intrinsic-width vertical stack at constrained tablet and mobile widths, preventing adjacent labels and direction badges from colliding.
- **1.6** — 2026-08-31 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Refreshed the background hero with a wider, softly elevated gradient panel, balanced headline wrapping, and improved body-copy measure. Added semantic overlay radius and shadow tokens without changing component markup.
