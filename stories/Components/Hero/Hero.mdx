...
- **1.6** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)):
  ...
  - Changed CTA groups from an inline row to an intrinsic-width vertical stack at constrained tablet and mobile widths, preventing adjacent labels and direction badges from colliding.
