...
- **1.6** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)):
  - Refreshed the background hero with a wider, softly elevated gradient panel, balanced headline wrapping, and improved body-copy measure. Added semantic overlay radius and shadow tokens without changing component markup.
