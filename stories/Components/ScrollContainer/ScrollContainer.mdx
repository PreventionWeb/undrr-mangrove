...
- **1.5** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Consolidated collection spacing into one moderate `spacing-150` flex gap and removed per-item margins, eliminating doubled whitespace between cards and keeping the collection edges flush with the viewport.
- **1.4** — 2026-08-31 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Replaced physical item margins with logical inline spacing so horizontal collections preserve their rhythm in RTL layouts.
- **1.3** — 2026-08-31 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Moved navigation below the collection, refreshed arrows as subtle circular controls with tactile states, and added proximity scroll snapping while preserving mouse drag and touch scrolling.
