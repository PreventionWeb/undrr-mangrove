...
- **1.2** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Completed the bar layout refresh with soft-filled jump controls, shared button and field radii, 44px targets, token-driven focus rings and reduced-motion-aware press feedback.
- **1.1** — 2026-09-01 ([#1086](https://github.com/unisdr/undrr-mangrove/pull/1086)): Refreshed the default pager with borderless 44px circular targets, softly tinted current and directional controls, stable token-driven hover/focus/press states, and visually compact arrow-only previous/next controls that retain their accessible labels.
