...
function buildIconDefinitions() {
  ...
  const header =
    ...
    ' * Icon Definitions\n' +
    ' *\n' +
    ' * Auto-generated SVG mask-image definitions for the Mangrove icon set.\n' +
    ' * Generated by scripts/icon-build.cjs — do not edit by hand.\n' +
    ' *\n' +
    ' * Full documentation:\n' +
    ' * https://github.com/unisdr/undrr-mangrove/blob/main/stories/Atom/Icons/Icons.mdx\n' +
    ' */\n' +
