...
> Edits to this file show up on both [GitHub](https://github.com/unisdr/undrr-mangrove/blob/main/docs/WRITING.md) and in [Storybook](https://preventionweb.github.io/undrr-mangrove/?path=/docs/contributing-writing-guidelines--docs).
