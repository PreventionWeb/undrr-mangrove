...
```html
<!-- Before (1.3.x) -->
<link rel="stylesheet" href="https://assets.undrr.org/mangrove/1.4.1/css/style.css">

<!-- After (1.4.0, using legacy variant) -->
<link rel="stylesheet" href="https://assets.undrr.org/mangrove/1.4.1/css/style-legacy.css">
```
