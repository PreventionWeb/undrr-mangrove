...
> Edits to this file show up on both [GitHub](https://github.com/unisdr/undrr-mangrove/blob/main/docs/ANALYTICS.md) and in [Storybook](https://preventionweb.github.io/undrr-mangrove/?path=/docs/platform-services-analytics-enhancements--docs).
...
- [Critical messaging](https://preventionweb.github.io/undrr-mangrove/?path=/docs/platform-services-critical-messaging--docs) — Emergency broadcast system for UNDRR pages
