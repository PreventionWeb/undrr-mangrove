...
<script type="module">
  import createHydrator from 'https://assets.undrr.org/mangrove/2.0.0-beta.2/components/hydrate.js';
  import ShareButtons, { fromElement } from 'https://assets.undrr.org/mangrove/2.0.0-beta.2/components/ShareButtons.js';
