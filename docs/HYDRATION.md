...
<script type="module">
  import createHydrator from 'https://assets.undrr.org/static/mangrove/2.0.0-alpha.4/components/hydrate.js';
  import ShareButtons, { fromElement } from 'https://assets.undrr.org/static/mangrove/2.0.0-alpha.4/components/ShareButtons.js';
